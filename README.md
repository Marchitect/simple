...
Simple is a static blog generator. You can write your blog online, and it will generate static html files in your repo named `username.github.io`, which is supported by [github pages](https://pages.github.com)
...
4. Click `Initilize` to set up basic files for your static blog site (patience counts).
...
7. Now you can browse the `your_user_name.github.io` site and enjoy that moment!
